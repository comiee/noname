game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"英雄",content:function (config,pack){
    ...
    character:{
        character:{
            "巴泽特":["female","qun",4,["逆光","格斗","longdan"],[]],
            "一方通行":["male","qun",4,["矢量"],[]],
        },
        translate:{
            "巴泽特":"巴泽特",
    ...
    forumURL:"",
    version:"1.0",
},files:{"character":["巴泽特.jpg","一方通行.jpg"],"card":[],"skill":[],"audio":[]}}})